...
<head>
	...
	<title>Add to Kezpezfood DB</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<h1 class="col-12 mt-4 mb-4 center">Add a Restaurant to my database!</h1>
		</div> <!-- .row -->
	</div> <!-- .container -->
	...
	<form action="add_confirm.php" method="POST">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9 mt-2">
					<button type="submit" class="btn search_btn">Submit</button>
